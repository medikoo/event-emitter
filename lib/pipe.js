...
module.exports = function (emitter1, emitter2) {
	...
	if (!emitter1.emit) throw new TypeError(emitter1 + ' is not emitter');

	pipe = {
		close: function () { remove.call(pipes, emitter2); }
	};
	if (!hasOwnProperty.call(emitter1, id)) defineProperty(emitter1, id, d({}));
